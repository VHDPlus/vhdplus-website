...
> <h2>Pre-order and save 10%</h2>
> <h4>Send us an e-mail to preorder@vhdplus.com in that you tell us what you would like to buy.</h4>
> When the device is back in stock, we will send you an e-mail with a coupon code, so you get a 10% discount.
> You won't get any other newsletters besides the one notification e-mail.

The prices can drop before release. Preorder is non-binding and just helps us with production.

## VHDPlus Core MAX10 - 49,99€

<Flex flexWrap='wrap' mx={-2}>
  <Box p={2} width={[ 1, 1/3 ]}>
    <a href="/docs/component_vhdpcore_max10">
      <Image src='/img/vhdpcore/Titelbild.JPG'/>
    </a>
  </Box>
  <Box p={2} width={[ 1, 2/3 ]}>
...
## VHDPlus Camera Extension - 14,99€
...
## VHDPlus Level Shifter Extension - 9,99€

<Flex flexWrap='wrap' mx={-2}>
  <Box p={2} width={[ 1, 1/3 ]}>
    <a href="/docs/components_levelshifter">
      <Image src='/img/extensions/levelshifter/Shifter_2.png'/>
    </a>
  </Box>
  <Box p={2} width={[ 1, 2/3 ]}>
