...
<Flex flexWrap='wrap' mx={-2}>
  <Box p={2} width={[ 1, 1/3 ]}>
    <a href="/docs/components/max1000">
      <Image src='/img/max1000/Image.jpg'/>
    </a>
  </Box>
  <Box p={2} width={[ 1, 2/3 ]}>
    The MAX1000 FPGA Development Board is most inexpensive way to start with FPGAs and the VHDPlus IDE. The capabilities of this development board are way beyond the usual microcontroller board you could get for this price.
  </Box>
</Flex>
<br/>
<hr/>
...
<Flex flexWrap='wrap' mx={-2}>
  <Box p={2} width={[ 1, 1/3 ]}>
    <a href="/docs/components/audio">
      <Image src='/img/extensions/audio/Audio.JPG'/>
    </a>
  </Box>
  <Box p={2} width={[ 1, 2/3 ]}>
...
<Flex flexWrap='wrap' mx={-2}>
  <Box p={2} width={[ 1, 1/3 ]}>
    <a href="/docs/components/maxco2">
      <Image src='/img/maxco2/TEI0024-01_0_600x600.jpg'/>
    </a>
  </Box>
  <Box p={2} width={[ 1, 2/3 ]}>
