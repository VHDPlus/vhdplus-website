...
Check if you [installed the drivers](/docs/getstarted_drivers), selected the correct FPGA, connected the FPGA with the PC and try to use the Quartus program window like in [this tutorial](https://www.youtube.com/watch?v=oGBgobUQ0bU&t=125).
