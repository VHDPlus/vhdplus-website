...
You can also ask questions on [Slack](https://join.slack.com/t/vhdplus/shared_invite/zt-iazvyzs4-EuWFJEUO06PezNYWuN0l3Q) 
or check out our [YouTube Videos](https://www.youtube.com/channel/UC7qiOvlaBSiWyAb7R1xTaEw).

If your problem doesn't include a Thread, you can also search for a solution in VHDL, because VHDP just expands the features of VHDL.
