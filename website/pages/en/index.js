      ...
      const Advantages = () => (
          <Container padding={['bottom', 'top']}>
              <GridBlock
                  contents={[
                      {
                          content: `FPGAs complete operations at astonishing rates and are not limited by thread count, because you program the hardware. That leads to incomparable performance especially in multi threaded tasks, like for robots, AI, audio and video processing or Crypto mining.<br/><br/>
