...
Prism.languages.vhdp = {
  ...
  'loopkeyword': /\b(main|class|component|thread|attributedeclaration|newfunction|newcomponent|functionparameter|functioncontent|vhdl|entity|is|library|use|of|architecture|component|generic|port|map|end|name|out|inout|buffer|generate|input|process|begin|to|downto|in|out|with|select|signal|constant|variable|range|others|rise|fall|type|array|package|function|stepfunction|connections|include|stepfor|\'length|to_integer|abs|resize|to_bit|to_bitvector|to_stdlogicvector|to_unsigned|to_signed)(?![-\S])?\b/ig,
